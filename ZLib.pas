//Remove next line to use SSE2 only
{$DEFINE AVX2}
{*******************************************************}
{                                                       }
...
function zlibVersion: MarshaledAString; inline;
function deflate(var strm: z_stream; flush: Integer): Integer; inline;
function deflateEnd(var strm: z_stream): Integer; inline;
function inflate(var strm: z_stream; flush: Integer): Integer; inline;
function inflateEnd(var strm: z_stream): Integer; inline;
function deflateSetDictionary(var strm: z_stream; dictionary: PByte;
  dictLength: Cardinal): Integer; inline;
function deflateCopy(var dest: z_stream; const source: z_stream): Integer; inline;
function deflateReset(var strm: z_stream): Integer; inline;
function deflateParams(var strm: z_stream;
  level, strategy: Integer): Integer; inline;
function deflateTune(var strm: z_stream;
  good_length, max_lazy, nice_length, max_chain: Integer): Integer; inline;
function deflateBound(var strm: z_stream; sourceLen: Cardinal): LongWord; inline;
function deflatePrime(var strm: z_stream; bits, value: Integer): Integer; inline;
function deflateSetHeader(var strm: z_stream; var head: gz_header): Integer; inline;
function inflateSetDictionary(var strm: z_stream;
  dictionary: PByte; dictLength: Cardinal): Integer; inline;
function inflateSync(var strm: z_stream): Integer; inline;
function inflateCopy(var dest, source: z_stream): Integer; inline;
function inflateReset(var strm: z_stream): Integer; inline;
function inflateReset2(var strm: z_stream; windowBits: Integer): Integer; inline;
function inflatePrime(var strm: z_stream; bits, value: Integer): Integer; inline;
function inflateMark(var strm: z_stream): LongInt; inline;
function inflateGetHeader(var strm: z_stream; var head: gz_header): Integer; inline;
function inflateBack(var strm: z_stream;
  in_: in_func; in_desc: Pointer;
  out_: out_func; out_desc: Pointer): Integer; inline;
function inflateBackEnd(var strm: z_stream): Integer; inline;
function zlibCompileFlags: LongWord; inline;
function compress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; inline;
function compress2(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord; level: Integer): Integer; inline;
function compressBound(sourceLen: LongWord): LongWord; inline;
function uncompress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; inline;
function gzdopen(fd: Integer; mode: MarshaledAString): gzFile; inline;
function gzbuffer(file_: gzFile; size: Cardinal): Integer; inline;
function gzsetparams(file_: gzFile; level, strategy: Integer): Integer; inline;
function gzread(file_: gzFile; const buf; len: Cardinal): Integer; inline;
function gzwrite(file_: gzFile; const buf; len: Cardinal): Integer; inline;
function gzputs(file_: gzFile; s: MarshaledASTring): Integer; inline;
function gzgets(file_: gzFile; buf: MarshaledAString; len: Integer): MarshaledAString; inline;
function gzputc(file_: gzFile; c: Integer): Integer; inline;
function gzgetc(file_: gzFile): Integer; inline;
function gzungetc(c: Integer; file_: gzFile): Integer; inline;
function gzflush(file_: gzFile; flush: Integer): Integer; inline;
function gzrewind(file_: gzFile): Integer; inline;
function gzeof(file_: gzFile): Integer; inline;
function gzdirect(file_: gzFile): Integer; inline;
function gzclose(file_: gzFile): Integer; inline;
function gzclose_r(file_: gzFile): Integer; inline;
function gzclose_w(file_: gzFile): Integer; inline;
function gzerror(file_: gzFile; var errnum: Integer): MarshaledAString; inline;
procedure gzclearerr(file_: gzFile); inline;
function adler32(adler: LongWord; buf: PByte; len: Cardinal): LongWord; inline;
function crc32(crc: UInt32; buf: PByte; len: Cardinal): UInt32; inline;
function deflateInit_(var strm: z_stream; level: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; inline;
function inflateInit_(var strm: z_stream;
  version: MarshaledAString; stream_size: Integer): Integer; inline;
function deflateInit2_(var strm: z_stream;
  level, method, windowBits, memLevel, strategy: Integer;
...
function inflateBackInit_(var strm: z_stream; windowBits: Integer;
  window: PByte; version: MarshaledAString;
  stream_size: Integer): Integer; inline;
function gzopen64(path: MarshaledAString; mode: MarshaledAString): gzFile; inline;
function gzseek64(file_: gzFile; offset: z_off64_t; flush: Integer): z_off64_t; inline;
function gztell64(file_: gzFile): z_off64_t; inline;
function gzoffset64(file_: gzFile): z_off64_t; inline;
function adler32_combine64(adler1, adler2: LongWord; len2: z_off64_t): LongWord; inline;
function crc32_combine64(crc1, crc2: LongWord; len2: z_off64_t): LongWord; inline;
function gzopen(path: MarshaledAString; mode: MarshaledAString): gzFile; inline;
function gzseek(file_: gzFile; offset: z_off_t; flush: Integer): z_off_t; inline;
function gztell(file_: gzFile): z_off_t; inline;
function gzoffset(file_: gzFile): z_off_t; inline;
function adler32_combine(adler1, adler2: LongWord; len2: z_off_t): LongWord; inline;
function crc32_combine(crc1, crc2: LongWord; len2: z_off_t): LongWord; inline;
function zError           (Err: Integer): MarshaledAString; inline;
function inflateSyncPoint (stream: z_streamp): Integer; inline;
function get_crc_table: PLongWord; inline;
function inflateUndermine (stream: z_streamp; size: Integer): Integer; inline;
function gzprintf(file_: gzFile; format: MarshaledAString): Integer; cdecl; varargs; external name '_gzprintf2';

function _zlibVersion: MarshaledAString; cdecl; external;
function _deflate(var strm: z_stream; flush: Integer): Integer; cdecl; external;
function _deflateEnd(var strm: z_stream): Integer; cdecl; external;
function _inflate(var strm: z_stream; flush: Integer): Integer; cdecl; external;
function _inflateEnd(var strm: z_stream): Integer; cdecl; external;
function _deflateSetDictionary(var strm: z_stream; dictionary: PByte;
  dictLength: Cardinal): Integer; cdecl; external;
function _deflateCopy(var dest: z_stream; const source: z_stream): Integer; cdecl; external;
function _deflateReset(var strm: z_stream): Integer; cdecl; external;
function _deflateParams(var strm: z_stream;
  level, strategy: Integer): Integer; cdecl; external;
function _deflateTune(var strm: z_stream;
  good_length, max_lazy, nice_length, max_chain: Integer): Integer; cdecl; external;
function _deflateBound(var strm: z_stream; sourceLen: Cardinal): LongWord; cdecl; external;
function _deflatePrime(var strm: z_stream; bits, value: Integer): Integer; cdecl; external;
function _deflateSetHeader(var strm: z_stream; var head: gz_header): Integer; cdecl; external;
function _inflateSetDictionary(var strm: z_stream;
  dictionary: PByte; dictLength: Cardinal): Integer; cdecl; external;
function _inflateSync(var strm: z_stream): Integer; cdecl; external;
function _inflateCopy(var dest, source: z_stream): Integer; cdecl; external;
function _inflateReset(var strm: z_stream): Integer; cdecl; external;
function _inflateReset2(var strm: z_stream; windowBits: Integer): Integer; cdecl; external;
function _inflatePrime(var strm: z_stream; bits, value: Integer): Integer; cdecl; external;
function _inflateMark(var strm: z_stream): LongInt; cdecl; external;
function _inflateGetHeader(var strm: z_stream; var head: gz_header): Integer; cdecl; external;
function _inflateBack(var strm: z_stream;
  in_: in_func; in_desc: Pointer;
  out_: out_func; out_desc: Pointer): Integer; cdecl; external;
function _inflateBackEnd(var strm: z_stream): Integer; cdecl; external;
function _zlibCompileFlags: LongWord; cdecl; external;
function _compress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; cdecl; external;
function _compress2(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord; level: Integer): Integer; cdecl; external;
function _compressBound(sourceLen: LongWord): LongWord; cdecl; external;
function _uncompress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; cdecl; external;
function _gzdopen(fd: Integer; mode: MarshaledAString): gzFile; cdecl; external;
function _gzbuffer(file_: gzFile; size: Cardinal): Integer; cdecl; external;
function _gzsetparams(file_: gzFile; level, strategy: Integer): Integer; cdecl; external;
function _gzread(file_: gzFile; const buf; len: Cardinal): Integer; cdecl; external;
function _gzwrite(file_: gzFile; const buf; len: Cardinal): Integer; cdecl; external;
function _gzprintf(file_: gzFile; format: MarshaledAString): Integer; cdecl; varargs; external;
function _gzputs(file_: gzFile; s: MarshaledASTring): Integer; cdecl; external;
function _gzgets(file_: gzFile; buf: MarshaledAString; len: Integer): MarshaledAString; cdecl; external;
function _gzputc(file_: gzFile; c: Integer): Integer; cdecl; external;
function _gzgetc(file_: gzFile): Integer; cdecl; external;
function _gzungetc(c: Integer; file_: gzFile): Integer; cdecl; external;
function _gzflush(file_: gzFile; flush: Integer): Integer; cdecl; external;
function _gzrewind(file_: gzFile): Integer; cdecl; external;
function _gzeof(file_: gzFile): Integer; cdecl; external;
function _gzdirect(file_: gzFile): Integer; cdecl; external;
function _gzclose(file_: gzFile): Integer; cdecl; external;
function _gzclose_r(file_: gzFile): Integer; cdecl; external;
function _gzclose_w(file_: gzFile): Integer; cdecl; external;
function _gzerror(file_: gzFile; var errnum: Integer): MarshaledAString; cdecl; external;
procedure _gzclearerr(file_: gzFile); cdecl; external;
function _adler32(adler: LongWord; buf: PByte; len: Cardinal): LongWord; cdecl; external;
function _crc32(crc: UInt32; buf: PByte; len: Cardinal): UInt32; cdecl; external;
function _deflateInit_(var strm: z_stream; level: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; cdecl; external;
function _inflateInit_(var strm: z_stream;
  version: MarshaledAString; stream_size: Integer): Integer; cdecl; external;
function _deflateInit2_(var strm: z_stream;
  level, method, windowBits, memLevel, strategy: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; cdecl; external;
function _inflateInit2_(var strm: z_stream; windowBits: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; cdecl; external;
function _inflateBackInit_(var strm: z_stream; windowBits: Integer;
  window: PByte; version: MarshaledAString;
  stream_size: Integer): Integer; cdecl; external;
function _gzopen64(path: MarshaledAString; mode: MarshaledAString): gzFile; cdecl; external;
function _gzseek64(file_: gzFile; offset: z_off64_t; flush: Integer): z_off64_t; cdecl; external;
function _gztell64(file_: gzFile): z_off64_t; cdecl; external;
function _gzoffset64(file_: gzFile): z_off64_t; cdecl; external;
function _adler32_combine64(adler1, adler2: LongWord; len2: z_off64_t): LongWord; cdecl; external;
function _crc32_combine64(crc1, crc2: LongWord; len2: z_off64_t): LongWord; cdecl; external;
function _gzopen(path: MarshaledAString; mode: MarshaledAString): gzFile; cdecl; external;
function _gzseek(file_: gzFile; offset: z_off_t; flush: Integer): z_off_t; cdecl; external;
function _gztell(file_: gzFile): z_off_t; cdecl; external;
function _gzoffset(file_: gzFile): z_off_t; cdecl; external;
function _adler32_combine(adler1, adler2: LongWord; len2: z_off_t): LongWord; cdecl; external;
function _crc32_combine(crc1, crc2: LongWord; len2: z_off_t): LongWord; cdecl; external;
function _zError           (Err: Integer): MarshaledAString; cdecl; external;
function _inflateSyncPoint (stream: z_streamp): Integer; cdecl; external;
function _get_crc_table: PLongWord; cdecl; external;
function _inflateUndermine (stream: z_streamp; size: Integer): Integer; cdecl; external;
...
{$IFDEF WIN32}
function zlibVersion: MarshaledAString; begin exit(_zlibVersion) end;
function deflate(var strm: z_stream; flush: Integer): Integer; begin exit(_deflate(strm,flush)) end;
function deflateEnd(var strm: z_stream): Integer; begin exit(_deflateEnd(strm)) end;
function inflate(var strm: z_stream; flush: Integer): Integer; begin exit(_inflate(strm,flush)) end;
function inflateEnd(var strm: z_stream): Integer; begin exit(_inflateEnd(strm)) end;
function deflateSetDictionary(var strm: z_stream; dictionary: PByte;
  dictLength: Cardinal): Integer; begin exit(_deflateSetDictionary(strm,dictionary,dictLength)) end;
function deflateCopy(var dest: z_stream; const source: z_stream): Integer; begin exit(_deflateCopy(dest,source)) end;
function deflateReset(var strm: z_stream): Integer; begin exit(_deflateReset(strm)) end;
function deflateParams(var strm: z_stream;
  level, strategy: Integer): Integer; begin exit(_deflateParams(strm,level, strategy)) end;
function deflateTune(var strm: z_stream;
  good_length, max_lazy, nice_length, max_chain: Integer): Integer; begin exit(_deflateTune(strm,good_length,max_lazy, nice_length, max_chain)) end;
function deflateBound(var strm: z_stream; sourceLen: Cardinal): LongWord; begin exit(_deflateBound(strm,sourceLen)) end;
function deflatePrime(var strm: z_stream; bits, value: Integer): Integer; begin exit(_deflatePrime(strm,bits, value)) end;
function deflateSetHeader(var strm: z_stream; var head: gz_header): Integer; begin exit(_deflateSetHeader(strm,head)) end;
function inflateSetDictionary(var strm: z_stream;
  dictionary: PByte; dictLength: Cardinal): Integer; begin exit(_inflateSetDictionary(strm,dictionary,dictLength)) end;
function inflateSync(var strm: z_stream): Integer; begin exit(_inflateSync(strm)) end;
function inflateCopy(var dest, source: z_stream): Integer; begin exit(_inflateCopy(dest, source)) end;
function inflateReset(var strm: z_stream): Integer; begin exit(_inflateReset(strm)) end;
function inflateReset2(var strm: z_stream; windowBits: Integer): Integer; begin exit(_inflateReset2(strm,windowBits)) end;
function inflatePrime(var strm: z_stream; bits, value: Integer): Integer; begin exit(_inflatePrime(strm,bits, value)) end;
function inflateMark(var strm: z_stream): LongInt; begin exit(_inflateMark(strm)) end;
function inflateGetHeader(var strm: z_stream; var head: gz_header): Integer; begin exit(_inflateGetHeader(strm,head)) end;
function inflateBack(var strm: z_stream;
  in_: in_func; in_desc: Pointer;
  out_: out_func; out_desc: Pointer): Integer; begin exit(_inflateBack(strm,in_,in_desc,out_,out_desc)) end;
function inflateBackEnd(var strm: z_stream): Integer; begin exit(_inflateBackEnd(strm)) end;
function zlibCompileFlags: LongWord; begin exit(_zlibCompileFlags) end;
function compress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; begin exit(_compress(dest,destLen,source,sourceLen)) end;
function compress2(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord; level: Integer): Integer; begin exit(_compress2(dest,destLen,source,sourceLen,level)) end;
function compressBound(sourceLen: LongWord): LongWord; begin exit(_compressBound(sourceLen)) end;
function uncompress(dest: PByte; var destLen: LongWord;
  source: PByte; sourceLen: LongWord): Integer; begin exit(_uncompress(dest,destLen,source,sourceLen)) end;
function gzdopen(fd: Integer; mode: MarshaledAString): gzFile; begin exit(_gzdopen(fd,mode)) end;
function gzbuffer(file_: gzFile; size: Cardinal): Integer; begin exit(_gzbuffer(file_,size)) end;
function gzsetparams(file_: gzFile; level, strategy: Integer): Integer; begin exit(_gzsetparams(file_,level, strategy)) end;
function gzread(file_: gzFile; const buf; len: Cardinal): Integer; begin exit(_gzread(file_,buf,len)) end;
function gzwrite(file_: gzFile; const buf; len: Cardinal): Integer; begin exit(_gzwrite(file_,buf,len)) end;
function gzputs(file_: gzFile; s: MarshaledASTring): Integer; begin exit(_gzputs(file_,s)) end;
function gzgets(file_: gzFile; buf: MarshaledAString; len: Integer): MarshaledAString; begin exit(_gzgets(file_,buf,len)) end;
function gzputc(file_: gzFile; c: Integer): Integer; begin exit(_gzputc(file_,c)) end;
function gzgetc(file_: gzFile): Integer; begin exit(_gzgetc(file_)) end;
function gzungetc(c: Integer; file_: gzFile): Integer; begin exit(_gzungetc(c,file_)) end;
function gzflush(file_: gzFile; flush: Integer): Integer; begin exit(_gzflush(file_,flush)) end;
function gzrewind(file_: gzFile): Integer; begin exit(_gzrewind(file_)) end;
function gzeof(file_: gzFile): Integer; begin exit(_gzeof(file_)) end;
function gzdirect(file_: gzFile): Integer; begin exit(_gzdirect(file_)) end;
function gzclose(file_: gzFile): Integer; begin exit(_gzclose(file_)) end;
function gzclose_r(file_: gzFile): Integer; begin exit(_gzclose_r(file_)) end;
function gzclose_w(file_: gzFile): Integer; begin exit(_gzclose_w(file_)) end;
function gzerror(file_: gzFile; var errnum: Integer): MarshaledAString; begin exit(_gzerror(file_,errnum)) end;
procedure gzclearerr(file_: gzFile); begin _gzclearerr(file_) end;
function adler32(adler: LongWord; buf: PByte; len: Cardinal): LongWord; begin exit(_adler32(adler,buf,len)) end;
function crc32(crc: UInt32; buf: PByte; len: Cardinal): UInt32; begin exit(_crc32(crc,buf,len)) end;
function deflateInit_(var strm: z_stream; level: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; begin exit(_deflateInit_(strm,level,version,stream_size)) end;
function inflateInit_(var strm: z_stream;
  version: MarshaledAString; stream_size: Integer): Integer; begin exit(_inflateInit_(strm,version,stream_size)) end;
function deflateInit2_(var strm: z_stream;
  level, method, windowBits, memLevel, strategy: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; begin exit(_deflateInit2_(strm,level, method, windowBits, memLevel, strategy,version,stream_size)) end;
function inflateInit2_(var strm: z_stream; windowBits: Integer;
  version: MarshaledAString; stream_size: Integer): Integer; begin exit(_inflateInit2_(strm,windowBits,version,stream_size)) end;
function inflateBackInit_(var strm: z_stream; windowBits: Integer;
  window: PByte; version: MarshaledAString;
  stream_size: Integer): Integer; begin exit(_inflateBackInit_(strm,windowBits,window,version,stream_size)) end;
function gzopen64(path: MarshaledAString; mode: MarshaledAString): gzFile; begin exit(_gzopen64(path,mode)) end;
function gzseek64(file_: gzFile; offset: z_off64_t; flush: Integer): z_off64_t; begin exit(_gzseek64(file_,offset,flush)) end;
function gztell64(file_: gzFile): z_off64_t; begin exit(_gztell64(file_)) end;
function gzoffset64(file_: gzFile): z_off64_t; begin exit(_gzoffset64(file_)) end;
function adler32_combine64(adler1, adler2: LongWord; len2: z_off64_t): LongWord; begin exit(_adler32_combine64(adler1, adler2,len2)) end;
function crc32_combine64(crc1, crc2: LongWord; len2: z_off64_t): LongWord; begin exit(_crc32_combine64(crc1, crc2,len2)) end;
function gzopen(path: MarshaledAString; mode: MarshaledAString): gzFile; begin exit(_gzopen(path,mode)) end;
function gzseek(file_: gzFile; offset: z_off_t; flush: Integer): z_off_t; begin exit(_gzseek(file_,offset,flush)) end;
function gztell(file_: gzFile): z_off_t; begin exit(_gztell(file_)) end;
function gzoffset(file_: gzFile): z_off_t; begin exit(_gzoffset(file_)) end;
function adler32_combine(adler1, adler2: LongWord; len2: z_off_t): LongWord; begin exit(_adler32_combine(adler1, adler2,len2)) end;
function crc32_combine(crc1, crc2: LongWord; len2: z_off_t): LongWord; begin exit(_crc32_combine(crc1, crc2,len2)) end;
function zError(Err: Integer): MarshaledAString; begin exit(_zError(Err)) end;
function inflateSyncPoint (stream: z_streamp): Integer; begin exit(_inflateSyncPoint (stream)) end;
function get_crc_table: PLongWord; begin exit(_get_crc_table) end;
function inflateUndermine (stream: z_streamp; size: Integer): Integer; begin exit(_inflateUndermine (stream,size)) end;
{$ENDIF}
end.
